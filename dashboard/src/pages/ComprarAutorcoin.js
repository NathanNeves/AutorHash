...
function ComprarAutorcoin() {
  ...
  return (
    <>
      ...
      <p className="text-gray-700 dark:text-gray-300">A quantidade de AutorCoin adquirida é igual a 1000x (um mil vezes) a quantidade de Ethereum transferida, sendo cobrada uma taxa de AUT$ 0,05.</p> <br/>
<div>
